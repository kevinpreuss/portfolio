...
})(["max-width:800px;font-size:24px;line-height:40px;font-weight:300;padding-bottom:10.6rem;color:rgba(255,255,255,0.5);text-align:center;@media ", "{max-width:670px;font-size:20px;line-height:32px;padding-bottom:24px;}@media ", "{font-size:16px;line-height:24px;padding-bottom:16px;}"], function (props) {
  return props.theme.breakpoints.md;
}, function (props) {
  return props.theme.breakpoints.sm;
});
